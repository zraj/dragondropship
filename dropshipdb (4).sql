...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 11, 2017 at 09:45 AM
...
INSERT INTO `amphures` (`AMPHUR_ID`, `AMPHUR_CODE`, `AMPHUR_NAME`, `GEO_ID`, `PROVINCE_ID`) VALUES
...
INSERT INTO `attributes` (`attribute_id`, `name`, `created_by`, `created_at`, `updated_at`) VALUES
(5, 'Size', 3, '2017-04-16 11:04:18', '2017-04-16 11:16:35'),
(6, 'Color', 3, '2017-04-16 11:04:26', '2017-04-16 11:16:26'),
(7, 'Material', 1, '2017-04-23 14:57:37', '2017-04-23 14:57:37');
...
CREATE TABLE `attributes_values` (
  ...
  `value_name` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `attributes_values` (`att_value_id`, `value_name`, `attribute_id`, `created_by`, `created_at`, `updated_at`) VALUES
(11, 'Green', 6, 3, '2017-04-22 16:54:40', '2017-04-22 16:54:40'),
(12, 'Blue', 6, 3, '2017-04-22 16:55:25', '2017-04-22 16:55:25'),
(13, 'S', 5, 3, '2017-04-22 16:55:41', '2017-04-22 16:55:41'),
(14, 'M', 5, 3, '2017-04-22 16:55:50', '2017-04-22 16:55:50'),
(15, 'L', 5, 3, '2017-04-22 16:55:56', '2017-04-22 16:55:56'),
(16, 'XL', 5, 3, '2017-04-22 16:56:01', '2017-04-22 16:56:01'),
(17, 'BLACK', 6, 3, '2017-04-22 16:56:22', '2017-04-22 16:56:22'),
(18, 'WHITE', 6, 3, '2017-04-22 16:56:28', '2017-04-22 16:56:28'),
(19, 'XXL', 5, 1, '2017-04-23 14:56:37', '2017-04-23 14:56:37'),
(20, 'Plastic', 7, 1, '2017-04-23 14:57:54', '2017-04-23 14:57:54'),
(21, 'Metal', 7, 1, '2017-04-23 14:58:04', '2017-04-23 14:58:04');
...
(1, 'ไทยพาณิชย์', 'scb.png', '2017-05-11 17:00:00', '2017-05-11 17:00:00'),
(2, 'กรุงไทย', 'ktb.png', '2017-05-11 17:00:00', '2017-05-11 17:00:00'),
(3, 'กสิกรไทย', 'kbank.png', '2017-05-11 17:00:00', '2017-05-11 17:00:00');
...
CREATE TABLE `bank_master` (
  `id` int(11) NOT NULL,
  `bank_number` varchar(10) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `bank_master` (`id`, `bank_number`, `account_name`, `bank_type`, `created_at`, `updated_at`) VALUES
(1, '0952543196', 'SUPPAKIAT THIPAKSORN', 1, NULL, NULL),
(2, '1112223330', 'MAYTINEE WORAPRUKDEEKUL', 2, NULL, NULL);
...
CREATE TABLE `bank_transaction` (
  ...
  `cur_balance` double DEFAULT NULL,
  `owner` int(11) NOT NULL,
  `from_bank` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `from_bank_type` int(11) DEFAULT NULL,
  `remarks` varchar(400) COLLATE utf8_unicode_ci DEFAULT NULL,
  `trantype` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `to_bank` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `to_bank_type` int(11) DEFAULT NULL,
  `tran_image` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `reference_code` varchar(10) COLLATE utf8_unicode_ci DEFAULT NULL,
  `status` int(11) NOT NULL DEFAULT '0',
  `trantime` varchar(20) COLLATE utf8_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `bank_transaction` (`id`, `amount`, `prev_balance`, `cur_balance`, `owner`, `from_bank`, `from_bank_type`, `remarks`, `trantype`, `to_bank`, `to_bank_type`, `tran_image`, `reference_code`, `status`, `trantime`, `created_at`, `updated_at`) VALUES
(18, 800, -870, -70, 11, '0955551234', 1, NULL, 'ฝากเงิน', '0952543196', 1, 'w6gETQerYrr2OaPJNHeDELxalgbIBiH9GB9Bpoac.jpeg', NULL, 1, '18:41', '2017-10-11 11:41:49', '2017-10-11 12:14:32'),
(21, -840, 0, -840, 11, NULL, NULL, 'ซื้อสินค้า', 'ซื้อสินค้า', NULL, NULL, NULL, 'OR15', 1, NULL, '2017-10-11 11:53:08', '2017-10-11 12:13:07'),
(22, -30, -840, -870, 11, NULL, NULL, 'ค่าจัดส่ง', 'ค่าจัดส่ง', NULL, NULL, NULL, 'OR15', 1, NULL, '2017-10-11 11:53:08', '2017-10-11 12:13:41'),
(23, -1120, NULL, NULL, 11, NULL, NULL, 'ซื้อสินค้า', 'ซื้อสินค้า', NULL, NULL, NULL, 'OR17', 0, NULL, '2017-10-12 04:41:59', '2017-10-12 04:41:59'),
(24, -45, NULL, NULL, 11, NULL, NULL, 'ค่าจัดส่ง', 'ค่าจัดส่ง', NULL, NULL, NULL, 'OR17', 0, NULL, '2017-10-12 04:41:59', '2017-10-12 04:41:59'),
(25, -1980, NULL, NULL, 11, NULL, NULL, 'ซื้อสินค้า', 'ซื้อสินค้า', NULL, NULL, NULL, 'OR18', 0, NULL, '2017-10-12 10:53:37', '2017-10-12 10:53:37'),
(26, -75, NULL, NULL, 11, NULL, NULL, 'ค่าจัดส่ง', 'ค่าจัดส่ง', NULL, NULL, NULL, 'OR18', 0, NULL, '2017-10-12 10:53:37', '2017-10-12 10:53:37'),
(27, -2360, NULL, NULL, 11, NULL, NULL, 'ซื้อสินค้า', 'ซื้อสินค้า', NULL, NULL, NULL, 'OR19', 0, NULL, '2017-10-13 04:50:11', '2017-10-13 04:50:11'),
(28, -65, NULL, NULL, 11, NULL, NULL, 'ค่าจัดส่ง', 'ค่าจัดส่ง', NULL, NULL, NULL, 'OR19', 0, NULL, '2017-10-13 04:50:11', '2017-10-13 04:50:11');
...
INSERT INTO `cart` (`id`, `product_id`, `qty`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(28, 28, 3, 6, '2017-10-11 11:52:48', '2017-10-11 11:53:08', '2017-10-11 11:53:08'),
(29, 28, 4, 6, '2017-10-12 04:37:09', '2017-10-12 04:41:59', '2017-10-12 04:41:59'),
(30, 29, 1, 6, '2017-10-12 10:52:09', '2017-10-12 10:53:37', '2017-10-12 10:53:37'),
(31, 28, 6, 6, '2017-10-12 10:52:14', '2017-10-12 10:53:37', '2017-10-12 10:53:37'),
(32, 29, 6, 6, '2017-10-13 04:39:05', '2017-10-13 04:50:11', '2017-10-13 04:50:11'),
(33, 28, 2, 6, '2017-10-13 04:39:09', '2017-10-13 04:50:11', '2017-10-13 04:50:11'),
(34, 29, 50, 6, '2017-10-13 04:56:10', '2017-10-24 10:37:34', '2017-10-24 10:37:34'),
(35, 28, 51, 6, '2017-10-13 04:56:13', '2017-10-24 10:37:36', '2017-10-24 10:37:36');
...
CREATE TABLE `category` (
  ...
  `cat_name` varchar(190) COLLATE utf8_unicode_ci NOT NULL,
  `cat_code` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `category` (`category_id`, `cat_name`, `cat_code`, `created_by`, `created_at`, `updated_at`) VALUES
(13, 'กางเกง', '05', 3, '2017-04-16 10:01:30', '2017-05-30 14:50:32'),
(14, 'เสื้อ', '04', 3, '2017-04-16 10:02:01', '2017-05-30 14:50:26'),
(15, 'เครื่องใช้ไฟฟ้า', '03', 3, '2017-04-16 10:02:13', '2017-05-30 14:50:18'),
(16, 'อาหารเสริม', '02', 3, '2017-04-16 10:02:36', '2017-05-30 14:50:12'),
(17, 'โทรศัพท์', '01', 3, '2017-04-16 10:03:09', '2017-05-30 14:50:03'),
(18, 'คอมพิวเตอร์', '06', 3, '2017-05-30 14:51:25', '2017-05-30 14:57:16');

-- --------------------------------------------------------

--
-- Table structure for table `cat_attributes`
--

CREATE TABLE `cat_attributes` (
  `id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
  `attribute_id` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
...
--
-- Dumping data for table `cat_attributes`
--

INSERT INTO `cat_attributes` (`id`, `category_id`, `attribute_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 13, 5, 1, '2017-04-23 00:45:13', '2017-04-23 00:45:13'),
(2, 17, 6, 1, '2017-04-23 02:31:50', '2017-04-23 02:31:50'),
(3, 13, 6, 1, '2017-04-23 14:40:10', '2017-04-23 14:40:10'),
(5, 16, 6, 1, '2017-04-23 14:53:51', '2017-04-23 14:53:51'),
(6, 15, 6, 1, '2017-04-23 14:55:07', '2017-04-23 14:55:07'),
(7, 16, 5, 1, '2017-04-23 14:56:16', '2017-04-23 14:56:16'),
(8, 17, 7, 1, '2017-04-23 14:58:15', '2017-04-23 14:58:15'),
(9, 14, 6, 1, '2017-04-23 15:00:03', '2017-04-23 15:00:03'),
(10, 17, 5, 1, '2017-04-24 04:27:10', '2017-04-24 04:27:10');
...
INSERT INTO `order_detail` (`id`, `orderid`, `product_id`, `qty`, `price`, `amount`, `created_at`, `updated_At`, `deleted_at`) VALUES
(22, 15, 28, 3, 280, 840, '2017-10-11 11:53:08', '2017-10-12 04:36:54', '2017-10-12 04:36:54'),
(24, 17, 28, 4, 280, 1120, '2017-10-12 04:41:59', '2017-10-12 04:41:59', NULL),
(25, 18, 29, 1, 300, 300, '2017-10-12 10:53:37', '2017-10-12 10:53:37', NULL),
(26, 18, 28, 6, 280, 1680, '2017-10-12 10:53:37', '2017-10-12 10:53:37', NULL),
(27, 19, 29, 6, 300, 1800, '2017-10-13 04:50:11', '2017-10-13 04:50:11', NULL),
(28, 19, 28, 2, 280, 560, '2017-10-13 04:50:11', '2017-10-13 04:50:11', NULL);
...
CREATE TABLE `order_head` (
  ...
  `pre_shipping_amt` double NOT NULL,
  `real_shipping_amt` double DEFAULT NULL,
  `sum_weight` int(11) NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `order_head` (`id`, `name`, `postcode`, `province`, `city`, `district`, `address`, `telephone`, `shipmethod`, `comments`, `status`, `product_amt`, `pre_shipping_amt`, `real_shipping_amt`, `sum_weight`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(15, 'ศุภเกียรติ ทิพย์อักษร', '10290', 'สมุทรปราการ', 'พระสมุทรเจดีย์', 'พระสมุทณเจดีย์', '317/37 หมู่บ้านพฤกษา 77/2 สุขสวัสดิ์-กาณจนาภิเษก, , แหลมฟ้าผ่า', '0878799766', 4, NULL, 0, 840, 30, NULL, 360, 6, '2017-10-11 11:53:08', '2017-10-12 04:36:54', '2017-10-12 04:36:54'),
(17, 'ศุภเกียรติ ทิพย์อักษร', '10290', 'สมุทรปราการ', 'พระสมุทรเจดีย์', 'พระสมุทณเจดีย์', '317/37 หมู่บ้านพฤกษา 77/2 สุขสวัสดิ์-กาณจนาภิเษก, , แหลมฟ้าผ่า', '0878799766', 2, NULL, 2, 1120, 45, NULL, 480, 6, '2017-10-12 04:41:59', '2017-10-12 16:12:00', NULL),
(18, 'นาย ก สกุลข', '31130', 'บุรีรัมย์', 'ลำปลายมาศ', 'ลำปลายมาศ', '14 หมู่ 6', '0929924461', 2, NULL, 0, 1980, 75, NULL, 840, 6, '2017-10-12 10:53:37', '2017-10-12 10:53:37', NULL),
(19, 'นาย ก', '10120', 'กรุงเทพมหานคร', 'เขตบางคอแหลม', 'บางโคล่', '132 ซ.7', '0929924461', 4, NULL, 1, 2360, 65, NULL, 960, 6, '2017-10-13 04:50:11', '2017-10-13 05:07:18', NULL);
...
CREATE TABLE `photos` (
  ...
  `item_style` varchar(5) COLLATE utf8_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `photos` (`id`, `photo_name`, `ref_id`, `item_style`, `created_by`, `created_at`, `updated_at`) VALUES
(33, 'WPdCBzmlVJ7wtxucwpYC2nTuAgcrL1GAKXFuYmqQ.jpeg', 1, 'DDL01', 3, '2017-06-17 08:01:11', '2017-06-17 08:01:11'),
(36, 'qCaVOl94Lw1bdK4L0pOgAlI4HQ9rk8tDxXXEbbE7.jpeg', 1, 'DDL01', 3, '2017-06-17 08:05:18', '2017-06-17 08:05:18'),
(38, 'TTzljxGrc7b86XeT6DKXyqiVCpjnkRAAWj6lUMEZ.jpeg', 1, 'DDL01', 3, '2017-06-17 08:16:37', '2017-06-17 08:16:37'),
(40, '0sOx9dlbXTt9SjWAwTm9a8Q0aFrpoOymXXSGX1hr.jpeg', 2, 'FMG02', 3, '2017-07-16 01:49:38', '2017-07-16 01:49:38'),
(41, 'Y2kduhA9Vn8Gkfa8hCQN7GoB1iPaaODPRkqZaEG4.jpeg', 2, 'FMG02', 1, '2017-07-25 06:46:40', '2017-07-25 06:46:40'),
(42, 'O3AVaLq7SucFiPXaMMPYXevU7hY1fpdpJ6SBnFbG.jpeg', 4, 'MBH01', 1, '2017-09-02 07:17:21', '2017-09-02 07:17:21');
...
CREATE TABLE `products` (
  ...
  `item_code` varchar(8) COLLATE utf8_unicode_ci DEFAULT NULL,
  `item_style` varchar(5) COLLATE utf8_unicode_ci DEFAULT NULL,
...
INSERT INTO `products` (`id`, `product_name`, `product_desc`, `base_image`, `base_price`, `category_id`, `style_id`, `item_code`, `item_style`, `L1`, `L2`, `L3`, `L4`, `L5`, `L6`, `L7`, `L8`, `L9`, `gallery_id`, `qty`, `status`, `created_by`, `store_id`, `created_at`, `updated_at`, `weight`, `deleted_at`) VALUES
(24, 'TEST Product 1', '<p>DEscscs Test</p>', NULL, 100, 13, 1, 'DDL01S45', 'DDL01', 300, 280, 270, 260, 250, 240, 230, 220, 200, NULL, 20, 0, 3, 3, '2017-06-17 05:02:32', '2017-09-04 01:45:49', 100, NULL),
(25, 'เคส02', '<p>Test</p>', NULL, 100, 13, 1, 'DDL01C02', 'DDL01', 399, 299, 299, 299, 299, 299, 299, 299, 299, NULL, 0, 0, 3, 3, '2017-07-15 05:36:38', '2017-07-15 22:10:04', 0, NULL),
(26, 'Fatman 1', '<p>TEST</p>', NULL, 250, 14, 2, 'FMG02S01', 'FMG02', 399, 399, 399, 399, 399, 399, 399, 399, 399, NULL, 60, 0, 3, 2, '2017-07-16 01:47:29', '2017-09-04 12:19:47', 150, NULL),
(27, 'เคสมือถือ S8', NULL, NULL, 200, 16, 1, 'DDL01SS8', 'DDL01', 200, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 20, 0, 3, 3, '2017-07-28 04:25:40', '2017-09-02 09:06:36', 100, NULL),
(28, 'กางเกงขาสั้นผู้ชายสีส้ม', NULL, NULL, 100, 13, 4, 'MBH01O32', 'MBH01', 280, 0, 0, 0, 0, 0, 0, 0, 0, NULL, 10, 0, 3, 1, '2017-07-28 04:42:44', '2017-10-12 06:31:03', 120, NULL),
(29, 'กางเกงขาสั้นผู้ชายสีน้ำตาล', NULL, NULL, 100, 13, 4, 'MBH01B34', 'MBH01', 300, 300, 300, 300, 300, 300, 300, 300, 300, NULL, 40, 0, 3, 1, '2017-10-12 10:47:06', '2017-10-25 03:52:35', 120, NULL);
...
INSERT INTO `product_inventory` (`id`, `product_id`, `qty`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(1, 28, 5, 1, '2017-09-02 08:50:15', '2017-09-02 08:50:15', NULL),
(2, 28, -2, 3, '2017-09-02 08:51:34', '2017-09-02 08:51:34', NULL),
(3, 28, 20, 3, '2017-09-02 08:54:22', '2017-09-02 08:54:22', NULL),
(4, 28, -6, 1, '2017-09-02 09:03:52', '2017-09-02 09:03:52', NULL),
(5, 28, 2, 1, '2017-09-02 09:04:28', '2017-09-02 09:04:28', NULL),
(6, 26, 100, 3, '2017-09-02 09:05:31', '2017-09-02 09:05:31', NULL),
(7, 26, -50, 1, '2017-09-02 09:06:03', '2017-09-02 09:06:03', NULL),
(8, 27, 20, 3, '2017-09-02 09:06:36', '2017-09-02 09:06:36', NULL),
(9, 24, 20, 3, '2017-09-04 01:45:49', '2017-09-04 01:45:49', NULL),
(10, 26, 10, 1, '2017-09-04 12:19:47', '2017-09-04 12:19:47', NULL),
(11, 28, -9, 1, '2017-10-12 06:31:03', '2017-10-12 06:31:03', NULL),
(12, 29, 30, 1, '2017-10-12 10:50:52', '2017-10-12 10:50:52', NULL),
(13, 29, 10, 3, '2017-10-25 03:52:35', '2017-10-25 03:52:35', NULL);
...
CREATE TABLE `reseller` (
  `id` int(11) NOT NULL,
  `reseller_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อบริษัท',
  `reseller_user` int(11) NOT NULL,
  ...
  `city` varchar(45) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'อำเภอ',
  `province` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_card` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `bank_account` varchar(15) COLLATE utf8_unicode_ci NOT NULL,
  `bank_type` int(11) NOT NULL,
  `bank_account_img` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `reseller` (`id`, `reseller_name`, `reseller_user`, `telephone`, `address`, `postcode`, `district`, `city`, `province`, `id_card`, `bank_account`, `bank_type`, `bank_account_img`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(3, 'ศุภเกียรติ ทิพย์อักษร', 11, '0878799766', '132 ซ.เจริญราษฎร์ 7 แขวงบางโคล่', '10120', 'บางโคล่', 'เขตยานนาวา', 'กรุงเทพมหานคร', 'y2HXNdCyW50QBeThNIH5kiNlodcEz4WsTLjXI6cP.png', '1112223330', 2, 'RJFJpsTvGI9IJ7QM5YqTAIOZsCyR7OYSTtYZ0tqX.png', 3, '2017-10-11 11:33:26', '2017-10-11 11:33:26', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `reseller_subscribe`
--

CREATE TABLE `reseller_subscribe` (
  `id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
INSERT INTO `shipping_cost` (`id`, `shipping_id`, `min_weight`, `max_weight`, `cost`, `created_at`, `updated_at`) VALUES
(1, 2, 0, 500, 45, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(2, 2, 500, 1000, 75, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(3, 2, 1000, 2000, 115, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(4, 2, 2000, 5000, 175, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(5, 2, 5000, 10000, 375, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(6, 3, 0, 500, 45, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(7, 3, 500, 1000, 75, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(8, 3, 1000, 2000, 115, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(9, 3, 2000, 5000, 175, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(10, 3, 5000, 10000, 375, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(11, 4, 0, 500, 30, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(12, 4, 500, 1000, 65, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(13, 4, 1000, 2000, 80, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(14, 4, 2000, 5000, 120, '2017-10-10 17:00:00', '2017-10-10 17:00:00'),
(15, 4, 5000, 10000, 200, '2017-10-10 17:00:00', '2017-10-10 17:00:00');
...
CREATE TABLE `shipping_services` (
  `id` int(11) NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `track_url` varchar(400) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `shipping_services` (`id`, `name`, `track_url`, `logo`, `created_at`, `updated_at`) VALUES
(2, 'ขนส่ง EMS', 'http://track.thailandpost.co.th/tracking/default.aspx', NULL, NULL, NULL),
(3, 'Kerry Express', 'https://th.kerryexpress.com/th/track/', NULL, NULL, NULL),
(4, 'ไปรษณีย์ลงทะเบียน', 'http://track.thailandpost.co.th/tracking/default.aspx', NULL, NULL, NULL);
...
CREATE TABLE `shop` (
  ...
  `reseller_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `shop_name` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `address_1` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `address_2` varchar(300) COLLATE utf8_unicode_ci NOT NULL,
  `tel_number` varchar(12) COLLATE utf8_unicode_ci NOT NULL,
  `created_by` int(11) NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `deleted_at` timestamp NULL DEFAULT NULL
...
INSERT INTO `shop` (`id`, `shop_user`, `reseller_id`, `store_id`, `shop_name`, `address_1`, `address_2`, `tel_number`, `created_by`, `created_at`, `updated_at`, `deleted_at`) VALUES
(4, 6, 3, 1, 'My shop', '317/37 หมู่บ้านพฤกษา 77/2', 'อ.พระสมุทรเจดีย์ จ.สมุทรปราการ 10290', '092-992-4461', 11, '2017-10-11 11:35:45', '2017-10-11 11:35:45', NULL);
...
CREATE TABLE `stores` (
  ...
  `short_name` varchar(2) COLLATE utf8_unicode_ci NOT NULL,
...
INSERT INTO `stores` (`id`, `store_name`, `short_name`, `supplier_id`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'Mafia Boy', 'MB', 3, 3, '2017-05-30 09:53:59', '2017-05-30 09:53:59'),
(2, 'Fatman', 'FM', 3, 3, '2017-05-30 10:27:43', '2017-05-30 10:39:46'),
(3, 'Case DD', 'DD', 4, 3, '2017-05-31 09:27:33', '2017-05-31 09:27:33'),
(4, 'ZRAJ TEST Shipping', 'TS', 3, 3, '2017-10-11 07:53:30', '2017-10-11 07:53:30');

-- --------------------------------------------------------

--
-- Table structure for table `store_shipping_services`
--

CREATE TABLE `store_shipping_services` (
  `id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
--
-- Dumping data for table `store_shipping_services`
--

INSERT INTO `store_shipping_services` (`id`, `store_id`, `shipping_service_id`, `created_at`, `updated_at`) VALUES
(11, 4, 2, '2017-10-11 08:10:55', '2017-10-11 08:10:55'),
(12, 1, 2, '2017-10-11 08:12:43', '2017-10-11 08:12:43'),
(13, 1, 4, '2017-10-11 08:12:43', '2017-10-11 08:12:43'),
(14, 2, 2, '2017-10-11 08:12:52', '2017-10-11 08:12:52'),
(15, 2, 3, '2017-10-11 08:12:52', '2017-10-11 08:12:52'),
(16, 3, 2, '2017-10-11 08:13:00', '2017-10-11 08:13:00'),
(17, 3, 3, '2017-10-11 08:13:00', '2017-10-11 08:13:00'),
(18, 3, 4, '2017-10-11 08:13:00', '2017-10-11 08:13:00');
...
CREATE TABLE `styles` (
  `id` int(11) NOT NULL,
  `style_code` varchar(3) COLLATE utf8_unicode_ci NOT NULL,
  `store_id` int(11) NOT NULL,
  `category_id` int(11) NOT NULL,
...
INSERT INTO `styles` (`id`, `style_code`, `store_id`, `category_id`, `description`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 'L01', 3, 17, 'test', 3, '2017-06-16 07:48:56', '2017-07-15 06:25:37'),
(2, 'G02', 2, 14, 'test g02', 3, '2017-06-16 07:56:17', '2017-06-16 07:56:17'),
(3, 'L02', 3, 13, 'test', 3, '2017-06-16 08:35:57', '2017-06-16 08:35:57'),
(4, 'H01', 1, 13, 'ttt', 3, '2017-06-16 08:36:08', '2017-06-16 08:36:08'),
(5, 'L03', 3, 17, 'เคสมือถือ', 3, '2017-07-15 05:39:14', '2017-07-15 05:39:14');
...
CREATE TABLE `suppliers` (
  `id` int(11) NOT NULL,
  `supplier_name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT 'ชื่อบริษัท',
...
INSERT INTO `suppliers` (`id`, `supplier_name`, `store_user`, `telephone`, `address`, `postcode`, `district`, `city`, `province`, `id_card`, `bank_account`, `bank_type`, `bank_account_img`, `created_by`, `created_at`, `updated_at`) VALUES
(3, 'ZRAJ Group', 1, '0878799766', '132 ซ.เจริญราษฎร์ 7 แขวงบางโคล่', '10120', 'บางโคล่', 'เขตยานนาวา', 'กรุงเทพมหานคร', 'PoWRSNMMgBRFHUbtgN8kXg2wXvmD5BbOdO4uYOCv.png', '0952543196', 1, 'PoWRSNMMgBRFHUbtgN8kXg2wXvmD5BbOdO4uYOCv.png', 3, '2017-05-29 08:46:38', '2017-05-29 09:11:41'),
(4, 'จ้า ขายส่ง', 10, '0878799766', '807/315', '12130', 'คูคต', 'ธัญบุรี', 'ปทุมธานี', 'YxaruFf0QTx84uQOGZsC0wgPvET9pME6t9cxpPwW.png', '0952543196', 1, 'YxaruFf0QTx84uQOGZsC0wgPvET9pME6t9cxpPwW.png', 3, '2017-05-31 09:22:01', '2017-05-31 09:22:01');
...
INSERT INTO `syslog` (`id`, `type`, `action`, `message`, `ref_id`, `recipient`, `created_by`, `created_at`, `updated_at`) VALUES
(1, 1, 'ADD_PRODUCT', 'สร้างสินค้าใหม่', 26, NULL, 3, '2017-07-16 01:48:26', '2017-07-16 01:48:26'),
(2, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 26, NULL, 3, '2017-07-16 02:08:16', '2017-07-16 02:08:16'),
(3, 1, 'ADD_PRODUCT', 'สร้างสินค้าใหม่', 27, NULL, 3, '2017-07-28 04:25:40', '2017-07-28 04:25:40'),
(4, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:26:36', '2017-07-28 04:26:36'),
(5, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:26:49', '2017-07-28 04:26:49'),
(6, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:29:32', '2017-07-28 04:29:32'),
(7, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:29:46', '2017-07-28 04:29:46'),
(8, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:30:02', '2017-07-28 04:30:02'),
(9, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 24, NULL, 3, '2017-07-28 04:32:49', '2017-07-28 04:32:49'),
(10, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 27, NULL, 3, '2017-07-28 04:41:37', '2017-07-28 04:41:37'),
(11, 1, 'ADD_PRODUCT', 'สร้างสินค้าใหม่', 28, NULL, 3, '2017-07-28 04:42:44', '2017-07-28 04:42:44'),
(12, 1, 'UPDATE_PRODUCT', 'อัพเดทข้อมูลสินค้า', 28, NULL, 3, '2017-07-28 04:46:54', '2017-07-28 04:46:54'),
(13, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 5 รวม 5', 28, NULL, 1, '2017-09-02 08:50:15', '2017-09-02 08:50:15'),
(14, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : -2 รวม 3', 28, NULL, 3, '2017-09-02 08:51:34', '2017-09-02 08:51:34'),
(15, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 20 รวม 23', 28, NULL, 3, '2017-09-02 08:54:22', '2017-09-02 08:54:22'),
(16, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : -6 รวม 17', 28, NULL, 1, '2017-09-02 09:03:52', '2017-09-02 09:03:52'),
(17, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 2 รวม 19', 28, NULL, 1, '2017-09-02 09:04:28', '2017-09-02 09:04:28'),
(18, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 100 รวม 100', 26, NULL, 3, '2017-09-02 09:05:31', '2017-09-02 09:05:31'),
(19, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : -50 รวม 50', 26, NULL, 1, '2017-09-02 09:06:03', '2017-09-02 09:06:03'),
(20, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 20 รวม 20', 27, NULL, 3, '2017-09-02 09:06:36', '2017-09-02 09:06:36'),
(21, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 20 รวม 20', 24, NULL, 3, '2017-09-04 01:45:49', '2017-09-04 01:45:49'),
(22, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 10 รวม 60', 26, NULL, 1, '2017-09-04 12:19:47', '2017-09-04 12:19:47'),
(24, 4, 'ORDER_CREATED', 'รอดำเนินการ', 17, NULL, 6, '2017-10-12 04:41:59', '2017-10-12 04:41:59'),
(25, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : -9 รวม 10', 28, NULL, 1, '2017-10-12 06:31:03', '2017-10-12 06:31:03'),
(26, 1, 'ADD_PRODUCT', 'สร้างสินค้าใหม่', 29, NULL, 3, '2017-10-12 10:47:06', '2017-10-12 10:47:06'),
(27, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 30 รวม 30', 29, NULL, 1, '2017-10-12 10:50:52', '2017-10-12 10:50:52'),
(28, 4, 'ORDER_CREATED', 'รอดำเนินการ', 18, NULL, 6, '2017-10-12 10:53:37', '2017-10-12 10:53:37'),
(38, 4, 'ORDER_PROCESS', 'กำลังจัดสินค้า', 17, NULL, 1, '2017-10-12 16:11:49', '2017-10-12 16:11:49'),
(39, 4, 'ORDER_PROCESS', 'รอจัดส่ง', 17, NULL, 1, '2017-10-12 16:12:00', '2017-10-12 16:12:00'),
(40, 4, 'ORDER_CREATED', 'รอดำเนินการ', 19, NULL, 6, '2017-10-13 04:50:11', '2017-10-13 04:50:11'),
(41, 4, 'ORDER_PROCESS', 'กำลังจัดสินค้า', 19, NULL, 1, '2017-10-13 05:07:18', '2017-10-13 05:07:18'),
(42, 1, 'UPDATE_PRODUCT', 'อัพเดทจำนวนสินค้า : 10 รวม 40', 29, NULL, 3, '2017-10-25 03:52:35', '2017-10-25 03:52:35');
...
CREATE TABLE `temples` (
  ...
  `t_name` varchar(50) COLLATE utf8_bin NOT NULL COMMENT 'ชื่อวัด',
  `t_sect` varchar(220) COLLATE utf8_bin NOT NULL,
  `t_num` varchar(50) COLLATE utf8_bin NOT NULL COMMENT 'เลขที่',
  `t_moo` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'หมู่ที่',
  `t_soi` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'ซอย',
  `t_road` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'ถนน',
  `district` varchar(220) COLLATE utf8_bin DEFAULT NULL COMMENT 'ตำบล',
  `amphur` varchar(220) COLLATE utf8_bin NOT NULL,
  `province` varchar(220) COLLATE utf8_bin NOT NULL,
  `geography` varchar(220) COLLATE utf8_bin NOT NULL,
  `budd_geo` varchar(10) COLLATE utf8_bin NOT NULL,
  `zipcode` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'รหัสไปรษณีย์',
  `t_phone1` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'เบอร์โทรวัด1',
  `t_phone2` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'เบอร์โทรวัด2',
  `fax` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'แฟกส์',
  `website` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'website',
  `email` varchar(50) COLLATE utf8_bin DEFAULT NULL COMMENT 'email',
  `googleMap` varchar(250) COLLATE utf8_bin DEFAULT NULL COMMENT 'googlemap'
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='เก็บรายชื่อวัด';
...
CREATE TABLE `users` (
  ...
  `avatar` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'nopic.png',
...
INSERT INTO `users` (`id`, `name`, `username`, `email`, `password`, `cash`, `level`, `user_type`, `avatar`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Suppakiat Thipaksorn', 'zraj', 'suppakiat@example.com', '$2y$10$Kehl05imvXDttZpntNJhqO9Xj74Dm7ZFq9F3eQL/Z4is/jOcprFvS', 0, 1, 3, 'jedi.jpg', '2PRCgAU9U7kVf16K8UQ5meK5jIU3X6j437HQwFNd4U4xl4eK8f9lmM71LbHe', '2017-04-15 05:24:51', '2017-04-15 05:24:51'),
(3, 'Admin', 'admin', 'admin@example.com', '$2y$10$h46bza6/bUFxq8dIJMUv8uSaNLkBDJ3./leqFHuPhegcT4BV9W9GW', 0, 9, 4, 'nopic.png', '1AqvookKhQbB3OH4qWaxBBlC9Ax1vKOKZRcK5feT9g1uFSqAjDbPvDYrsCJs', '2017-04-15 06:39:38', '2017-10-09 11:53:03'),
(4, 'ReSeller', 'reseller', 'reseller@example.com', '$2y$10$KKeldKAITfsQdK9n/G4sIu76sHBRwvz9jPn4m42vD0VIpboN8Fiay', 0, 1, 2, 'nopic.png', 'FQYFjF4MfmQOdWgbU5ua7xX908L5I9lOjvRRYSCkzUXUtqwLoauT6TQSquE2', '2017-04-15 07:36:41', '2017-04-15 07:36:41'),
(5, 'Seller', 'seller', 'seller@example.com', '$2y$10$fBN986r0fw4ISeRtGKuq3up8MJUXFWOfNhUOxjFGS/dynkpU7J1gC', 0, 1, 1, 'nopic.png', 'Cof7sLuwsr9uJ89BTn2VslI6x4EefhFdY6zlidgjL9FhkwjyRTMGQ7D5jv3A', '2017-04-15 07:39:01', '2017-04-15 07:39:01'),
(6, 'Maytinee', 'maytinee', 'maytinee@gmail.com', '$2y$10$Nxo1TACydCMwKcy3ifE5/ulpNBDg2O7OSzYGyDLxJQBZg7374jxIG', 0, 1, 1, 'nopic.png', 'Frt7cfuxVwAjM6u8eck6G5JyZJWv4vgEFLte3U549J5LoHYXek5tir2oGtVV', '2017-05-12 16:46:40', '2017-10-11 10:58:54'),
(7, 'My Supplier1', 'supplier1', 'supplier1@gmail.com', '$2y$10$.hSl3thMujBsxDoRBTF.P.CploLRlsHNz6YRwkyydUvtg0ivxAu/C', 0, 1, 1, 'nopic.png', NULL, '2017-05-12 16:59:28', '2017-05-12 16:59:28'),
(8, 'zzzz', 'zzz', 'everlastz@hotmail.com', '$2y$10$gwUKOoQrI71GrmmIM7TNyempb3My5cVylxOT5wg5A1TFAqSRTFmam', 0, 1, 1, 'nopic.png', NULL, '2017-05-12 17:02:27', '2017-05-12 17:02:27'),
(10, 'ศุภเกียรติ ทิพย์อักษร', 'zzrrr', 'eee@hotmail.com', '$2y$10$Eaf/27HcYCVrM3kXkDhOguqXZ9pB2dPzBlXEppn/DbQQ9HJKn3yZS', 0, 1, 3, 'nopic.png', '069JkeWwMGof5gKZdkNWm244CShcKMfabCPCL53TwYfgamjhbPCOxQONsazf', '2017-05-12 17:04:12', '2017-05-12 17:04:12'),
(11, 'ตัวแทนจำหน่าย A', 'resellera', 'resellera@gmail.com', '$2y$10$gRAukAUMOyQHHWZqLBPdv.LcXxQt.MTTty9xmBOvPt3j68M9hZbga', -70, 1, 2, 'nopic.png', 'Wb9gP7NlLrnNBNiXj9MxueKOqd1Dd3z7g6h7jWH1wBjtjRrYiowdIrizkIM4', '2017-08-26 06:53:24', '2017-10-11 12:14:32'),
(12, 'ถนัดค้าส่ง', 'supplier2', 'supplier2@gmail.com', '$2y$10$MEz9f/jlz37U8C/JR5g0b.FRwbNq3PthrVa7NdKJJHGK7SyDyhYu6', 0, 1, 3, 'nopic.png', '1VJofJSct5Mnu3TCKijkjtr0q3DjoiPUoJ1GG9vdxIdrEsP1zTDV1DhMK2kQ', '2017-09-02 19:24:46', '2017-09-02 19:24:46');
...
INSERT INTO `usertypes` (`id`, `user_type`, `type_name`) VALUES
(1, 1, 'Seller'),
(2, 2, 'Reseller'),
(3, 3, 'Supplier'),
(4, 4, 'Admin');
...
--
-- Indexes for table `cat_attributes`
--
ALTER TABLE `cat_attributes`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `order_detail`
  ADD PRIMARY KEY (`id`),
  ADD KEY `orderh_constraint` (`orderid`);
...
--
-- Indexes for table `reseller_subscribe`
--
ALTER TABLE `reseller_subscribe`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `shop`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `IDX_SHOPUSER` (`shop_user`);
...
--
-- Indexes for table `store_shipping_services`
--
ALTER TABLE `store_shipping_services`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `attributes_values`
  MODIFY `att_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
--
...
--
-- AUTO_INCREMENT for table `cat_attributes`
--
ALTER TABLE `cat_attributes`
...
ALTER TABLE `reseller`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `reseller_subscribe`
--
ALTER TABLE `reseller_subscribe`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `stores`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `store_shipping_services`
--
ALTER TABLE `store_shipping_services`
...
--
ALTER TABLE `zipcodes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7456;COMMIT;
