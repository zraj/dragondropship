...
<div class="card">
    <div class="card-header">
        <i class="fa fa-product-hunt"></i>แก้ไข Supplier
    </div>
    <div class="card-block">
        ...
        <form method="POST" action="/supplier/{{$supplier->id}}" enctype="multipart/form-data">
            ...
            <div class="row form-group">
                ...
                <div class="col-6">
                   <input type="text" class="form-control" name="name" required="" value="{{$supplier->supplier_name}}">
                </div>
            </div>
                ...
                <div class="col-3">
                  <select class="form-control" name="store_owner" id="">
                     @foreach($users as $user)
                       @if ($user->id == $supplier->store_user)
            ...
            <div class="row form-group">
                ...
                <div class="col-6">
                   <input type="text" class="form-control" name="telephone" required="" value="{{$supplier->telephone }}">
                </div>
            </div>
           ...
           <div class="row form-group">
              ...
              <div class="col-2 col-offset-4">
                 <input type="text" size="5" maxlength="5" class="form-control" value="{{$supplier->postcode }}" id="zipcode" name="postcode" required="">
              </div>
          </div>
             <div class="row form-group">
            ...
            <div class="row form-group">
               ...
               <div class="col-6">
                  <input type="text" class="form-control" value="{{$supplier->district }}" name="district" required="">
               </div>
           </div>
            <div class="row form-group">
           ...
           <div class="row form-group">
              ...
              <div class="col-6">
                <div id="address-province">
                      <select class="form-control" name="input-province">
                         <option value="{{$supplier->province }}">{{$supplier->province }}</option>
                      </select>
                </div>
              </div>
           </div>
            ...
            <div class="form-group row">
               <div class="col-2">รูปบัตรประชาชน:</div>
                <div class="col-6">
                    <a href="{{ asset('uploads/account/file/'.$supplier->id_card) }}" data-lightbox="product-image">
                  <img width="100px;" src="{{ asset('uploads/account/file/'.$supplier->id_card) }}" alt="">
                </a>
             ...
             <div class="form-group row">
               <div class="col-2">รูปบัญชีธนาคาร:</div>
                <div class="col-6">
                  <a href="{{ asset('uploads/account/file/'.$supplier->bank_account_img) }}" data-lightbox="product-image">
                    <img width="100px;" src="{{ asset('uploads/account/file/'.$supplier->bank_account_img) }}" alt="">
                  </a>
            ...
            <div class="row form-group">
               ...
               <div class="col-4">
                    ...
                    id="" aria-describedby="helpId" placeholder="" required="" value="{{$supplier->bank_account }}">
               </div>
            </div>
